"""
Django settings for payamgram project.
...
SECRET_KEY = '($!*e#wzy37_)klhhhkg^fgq#f@-)9ne)&#^ay-tn&=0pyoe6b'
...
WSGI_APPLICATION = 'payamgram.wsgi.application'
